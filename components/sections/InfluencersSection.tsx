...
export default function InfluencersSection() {
  ...
  const influencers = [
    ...
    },
    {
      ...
      image: '/images/influencers/sam-altman.png',
    ...
    },
    {
      ...
      image: '/images/influencers/jensen-huang.png',
    ...
    },
    {
      ...
      image: '/images/influencers/warren-buffett.jpg',
    ...
    },
    {
      ...
      image: '/images/influencers/stefan-zweig.png',
    ...
    },
    {
      ...
      image: '/images/influencers/hermann-hesse.png',
    ...
    },
    {
      ...
      image: '/images/influencers/haruki-murakami.png',
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60">
              {language === 'zh' ? '影响我的人' : 'Influencers'}
            </span>
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            {language === 'zh'
              ? '这些人和他们的作品深刻影响了我的思考方式、价值观和人生选择'
              : 'People and works that profoundly influenced my thinking, values, and choices'}
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {influencers.map((person, index) => (
            <div
              key={index}
              className="group apple-glass rounded-3xl p-8 animate-fade-in flex flex-col md:flex-row gap-6 hover:bg-white/5 transition-colors"
              style={{ animationDelay: `${index * 80}ms` }}
            >
              {/* Avatar Column */}
              <div className="flex flex-col items-center md:items-start gap-4 min-w-[120px]">
                <div className="relative w-24 h-24 rounded-full overflow-hidden ring-4 ring-white/10 shadow-2xl group-hover:ring-white/20 transition-all duration-500 group-hover:scale-105">
                  <Image
                    src={person.image}
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <blockquote className="text-sm text-gray-400 italic border-l-2 border-white/10 pl-4 py-1 mb-6">
                    {person.quote}
                  </blockquote>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {(language === 'zh' ? person.tags : person.tagsEn).map((tag, idx) => (
                    <span
                      key={idx}
                      className="px-2 py-1 rounded-md bg-white/5 border border-white/10 text-[10px] text-gray-400 hover:bg-white/10 hover:text-white transition-colors cursor-default"
                    >
                      {tag}
                    </span>
                  ))}
