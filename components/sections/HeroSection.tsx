...
const leftPhotos = [
  { src: '/images/hero/hero-1.jpg', rotate: -6, zIndex: 1 },
  { src: '/images/hero/hero-2.jpg', rotate: 3, zIndex: 2 },
  { src: '/images/hero/hero-6.jpg', rotate: -8, zIndex: 3 },
];

const rightPhotos = [
  { src: '/images/hero/hero-3.jpg', rotate: 5, zIndex: 2 },
  { src: '/images/hero/hero-4.jpg', rotate: -4, zIndex: 1 },
  { src: '/images/hero/hero-5.jpg', rotate: 7, zIndex: 3 },
];
...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center dark-section relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-32 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">

        {/* Left Photo Stack (Hidden on mobile) */}
        <div className="hidden lg:flex flex-1 justify-center items-center relative h-[500px]">
        ...
        {/* Center Content */}
        <div className="flex-1 text-center space-y-8 max-w-2xl">
          {/* Profile Image - Stable and Premium */}
          <div className="inline-block relative group/avatar">
            ...
            <div className="relative w-32 h-32 rounded-full bg-slate-900 mx-auto mb-8 flex items-center justify-center text-4xl font-bold cursor-pointer overflow-hidden ring-2 ring-white/20 shadow-2xl transition-transform duration-500 group-hover/avatar:scale-105">
              <Image
                src="/khalil.jpg"
                alt="Khalil"
                width={128}
          ...
          <div className="flex flex-wrap gap-3 justify-center pt-4 animate-fade-in delay-450">
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-all text-sm text-white"
            >
            ...
            <button
              className="group flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-all text-sm text-white relative"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Tags/Skills - Clean dark tags */}
          <div className="flex flex-wrap justify-center gap-2 pt-8">
            <span className="px-4 py-2 bg-slate-800 rounded-full text-xs text-white cursor-default animate-scale-in delay-300">
              ⚡ Cardano
            </span>
            <span className="px-4 py-2 bg-slate-800 rounded-full text-xs text-white cursor-default animate-scale-in delay-400">
              🚀 DApp Development
            </span>
            <span className="px-4 py-2 bg-slate-800 rounded-full text-xs text-white cursor-default animate-scale-in delay-500">
              💎 Web3
            </span>
            <span className="px-4 py-2 bg-slate-800 rounded-full text-xs text-white cursor-default animate-scale-in delay-600">
              ⚛️ React
            </span>
            <span className="px-4 py-2 bg-slate-800 rounded-full text-xs text-white cursor-default animate-scale-in delay-700">
              🎸 Guitar & Piano
            </span>
          </div>

          {/* Mobile Photo Gallery - appears after tags on mobile only */}
          <div className="lg:hidden w-full pt-12">
            <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
              {[...leftPhotos, ...rightPhotos].map((photo, index) => (
                <motion.div
                  key={index}
                ...
                >
                  <div
                    className="w-full h-full p-2 bg-white shadow-lg rounded-sm"
