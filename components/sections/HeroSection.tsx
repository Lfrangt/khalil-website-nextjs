        ...
        <div className="text-center space-y-8">
          ...
          <div className="flex gap-4 justify-center pt-4 animate-fade-in delay-450">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 glass-card rounded-lg hover:scale-105 transition-all text-sm text-white font-medium"
            >
            ...
            <button
              className="flex items-center gap-2 px-4 py-2 glass-card rounded-lg hover:scale-105 transition-all text-sm text-white font-medium group relative"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              Khalil6669
              <span className="absolute -top-2 -right-2 bg-white/90 text-gray-900 text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap font-semibold shadow-lg">
                微信号
              </span>
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-8">
            ...
            <a
              href="#contact"
              className="px-6 py-3 glass-card text-white rounded-lg hover:scale-105 transition-all text-sm font-medium animate-slide-up delay-600"
            >
              {t.common.contact}
            </a>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 pt-12">
            <span className="px-4 py-2 glass-card rounded-full text-sm text-white font-medium hover-lift cursor-default animate-scale-in delay-300">
              Cardano
            </span>
            <span className="px-4 py-2 glass-card rounded-full text-sm text-white font-medium hover-lift cursor-default animate-scale-in delay-400">
              DApp Development
            </span>
            <span className="px-4 py-2 glass-card rounded-full text-sm text-white font-medium hover-lift cursor-default animate-scale-in delay-500">
              Web3
            </span>
            <span className="px-4 py-2 glass-card rounded-full text-sm text-white font-medium hover-lift cursor-default animate-scale-in delay-600">
              React
            </span>
            <span className="px-4 py-2 glass-card rounded-full text-sm text-white font-medium hover-lift cursor-default animate-scale-in delay-700">
              🎸 Guitar & Piano
            </span>
          </div>
        </div>
